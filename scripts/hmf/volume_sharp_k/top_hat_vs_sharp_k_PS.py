...
def get_hmf_from_trajectories(initial_parameters, window_parameters, trajectories, barrier="spherical"):
...
plt.scatter(10**mid_bins, hmf_th,  marker="o", color=colors[0], label="top hat", s=20, alpha=1)
...
plt.savefig("/Users/lls/Documents/CODE/stored_files/hmf/volume_sharp_k/top_hat_vs_sharp_k_PS.png")