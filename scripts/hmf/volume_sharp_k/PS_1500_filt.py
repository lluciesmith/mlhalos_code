...
hmf_sk = hm.get_empirical_number_halos(PS_pred_mass_sk, ic)

PS_pred_mass_sphere_volume = np.load("/Users/lls/Documents/CODE/stored_files/hmf/trajectories_sharp_k/"
                                     "ALL_predicted_masses_1500_even_log_m_spaced.npy")
hmf_sphere = hm.get_empirical_number_halos(PS_pred_mass_sphere_volume, ic)

m_th, num_th = scripts.hmf.hmf_theory.theoretical_number_halos(ic)
...
plt.savefig("/Users/lls/Documents/CODE/stored_files/hmf/volume_sharp_k/PS_1500_radii_sk_vs_sphere_vol.png")
