...
test_den_ell = np.column_stack((test_features[:, :100], test_features[:, -1]))
del test_features

classifier = joblib.load("/home/lls/stored_files/shear_and_density/den+ell/classifier/classifier.pkl")
predicted_proba, true_labels = find_predicted_and_true_labels(classifier, test_den_ell)

np.save("/home/lls/stored_files/shear_and_density/den+ell/predicted_probabilities.npy", predicted_proba)
np.save("/home/lls/stored_files/shear_and_density/den+ell/true_labels.npy", true_labels)