...
path = "/Users/lls/Documents/mlhalos_files/stored_files/h4000_in_out_boundary/"
...
try:
    ...
    ic = parameters.InitialConditionsParameters(path="/Users/lls/Documents/mlhalos_files",
                                                load_final=True, max_halo_number=4000)
...
plt.title(r"$M_{\mathrm{IN/OUT}} = 10^{11} M_\odot$")
